...
public:
    ...
    void setupUi(QDialog *GebruikersGegevens)
    {
        ...
        QObject::connect(buttonBox, SIGNAL(accepted()), GebruikersGegevens, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), GebruikersGegevens, SLOT(reject()));
    ...
    {
        GebruikersGegevens->setWindowTitle(QApplication::translate("GebruikersGegevens", "Gebruikers Gegevens", nullptr));
        lblVoornaam->setText(QApplication::translate("GebruikersGegevens", "Voornaam:", nullptr));
        lblAchternaam->setText(QApplication::translate("GebruikersGegevens", "Achternaam:", nullptr));
        label->setText(QApplication::translate("GebruikersGegevens", "Gerslacht:", nullptr));
        label_2->setText(QApplication::translate("GebruikersGegevens", "Straat:", nullptr));
        label_3->setText(QApplication::translate("GebruikersGegevens", "Nummer:", nullptr));
        label_4->setText(QApplication::translate("GebruikersGegevens", "Gemeente:", nullptr));
        label_5->setText(QApplication::translate("GebruikersGegevens", "Postcode:", nullptr));
        label_6->setText(QApplication::translate("GebruikersGegevens", "Leeftijd:", nullptr));
    } // retranslateUi
