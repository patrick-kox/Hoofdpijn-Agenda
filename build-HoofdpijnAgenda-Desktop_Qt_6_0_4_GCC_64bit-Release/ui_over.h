...
public:
    ...
    {
        Over->setWindowTitle(QCoreApplication::translate("Over", "Over Hoofdpijnagenda Versie 3", nullptr));
        label_3->setText(QString());
        label->setText(QCoreApplication::translate("Over", "Over Hoofdpijnagenda", nullptr));
        label_5->setText(QCoreApplication::translate("Over", "Hoofdpijn Agenda is een persoonlijke hoofdpijn agenda gebaseerd op de Hoofdpijn Agenda van de \n"
"Belgian Headache Society (http://www.belgianheadachesociety.be) en de Belgische Hoofdpijn Liga (https://www.hoofdpijnen-belgie.be).", nullptr));
        label_2->setText(QCoreApplication::translate("Over", "Hoofdpijn Agenda Auteursrecht (C) 2021 Patrick Kox\n"
"\n"
